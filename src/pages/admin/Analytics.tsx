...
const AnalyticsPage = () => {
    ...
    const totalRangeDownloads = downloadsByPlatform.reduce((acc, curr) => acc + curr.count, 0) || 1; // Prevent division by zero
    const pieData = downloadsByPlatform.map(p => {
        ...
        return {
            ...
            value: Math.round((p.count / totalRangeDownloads) * 100),
            color
        };
    });
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="h-2 rounded-full bg-muted overflow-hidden">
                                        <motion.div
                                            initial={{ width: 0 }}
                                            animate={{ width: `${(platform.count / totalRangeDownloads) * 100}%` }}
