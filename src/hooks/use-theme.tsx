...
// Separate component or hook to apply initial color
if (typeof window !== "undefined") {
    const brandColor = localStorage.getItem('codenest-primary-color');
    if (brandColor) {
        document.documentElement.style.setProperty('--primary', brandColor);
        document.documentElement.style.setProperty('--ring', brandColor);
        document.documentElement.style.setProperty('--glow', brandColor);
    }
}
