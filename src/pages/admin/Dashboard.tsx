...
import { GlobalPulseMap } from "@/components/admin/GlobalPulseMap";
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
            ...
            <div className="flex flex-col gap-1">
                <div className="flex items-center gap-3">
                    <motion.h1
                        ...
                        className="text-4xl font-black bg-gradient-to-r from-white via-white/80 to-white/40 bg-clip-text text-transparent italic tracking-tight"
                    >
                        Dashboard
                    </motion.h1>
                    <motion.span
                        ...
                        className="rounded-full bg-primary/10 border border-primary/20 px-3 py-1.5 text-[10px] font-bold tracking-widest uppercase text-primary flex items-center gap-2 backdrop-blur-md"
                    >
                ...
                <motion.p
                    ...
                    className="text-muted-foreground/60 text-xs font-medium uppercase tracking-widest flex items-center gap-2"
                >
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                {stats.map((stat, index) => (
                    <motion.div
                        ...
                        className={cn(
                            "group relative overflow-hidden rounded-3xl border border-white/5 p-6 transition-all duration-300",
                            stat.title.includes("Downloads") && "admin-glow-blue",
                            stat.title.includes("Subscribers") && "admin-glow-emerald",
                            stat.title.includes("Page Views") && "admin-glow-primary",
                            stat.title.includes("Live") && "admin-glow-primary bg-red-500/5",
                        ...
                        <div className="relative">
                            ...
                            <div className="flex items-end justify-between">
                                <div>
                                    ...
                                    <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground/60">{stat.title}</p>
                                </div>
                    ...
                    <div className="space-y-3">
                        {quickActions.map((action, index) => (
                            ...
                            >
                                <Link to={action.href}>
                                    <div className={cn(
                                        "group relative overflow-hidden rounded-2xl border border-white/5 bg-white/[0.03] p-5 backdrop-blur-md",
                                        "hover:border-primary/40 hover:bg-white/[0.06] transition-all duration-500"
                                    )}>
                                        <div className={cn(
                                            "absolute inset-0 bg-gradient-to-r opacity-0 group-hover:opacity-10 transition-opacity duration-700",
                                            action.gradient
                                        )} />
