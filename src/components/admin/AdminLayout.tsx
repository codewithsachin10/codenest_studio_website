    ...
    return (
        <Link
            ...
            className={cn(
                ...
                isActive
                    ? "bg-primary/10 text-primary shadow-[inset_0_0_12px_rgba(var(--primary),0.1)] nav-active-glow"
...
const AdminLayout = () => {
    ...
    return (
        <div className="flex min-h-screen bg-background admin-mesh-bg selection:bg-primary/30">
            {/* Desktop Sidebar */}
            <aside
                className={cn(
                    "fixed left-0 top-0 z-40 hidden h-screen flex-col border-r border-white/5 bg-black/40 backdrop-blur-2xl transition-all duration-500 ease-in-out md:flex",
            ...
            <main
                className={cn(
                    "flex-1 pt-16 transition-all duration-500 ease-in-out md:pt-0",
